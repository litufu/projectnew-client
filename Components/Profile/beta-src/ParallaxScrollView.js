...
import { USER, FACEBOOK_LIST, GENERIC_LIST, SCREEN_WIDTH, SCREEN_HEIGHT, DEFAULT_WINDOW_MULTIPLIER, DEFAULT_NAVBAR_HEIGHT } from './constants';
...
class ParallaxScrollView extends Component {
  ...
  renderBackground() {
    const { windowHeight, backgroundSource, onBackgroundLoadEnd, onBackgroundLoadError } = this.props;
          ...
          {this.props.headerView ||
            (
              <View>
                ...
                >
                  <Image source={ USER.image} style={{height: 120, width: 120, borderRadius: 60}} />
                </View>
...
export default withNavigation(ParallaxScrollView)
